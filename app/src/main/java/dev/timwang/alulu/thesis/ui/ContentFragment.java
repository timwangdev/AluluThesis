...
public class ContentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.s21).setOnClickListener(new OnContentClick(vp, 43));
        view.findViewById(R.id.s22).setOnClickListener(new OnContentClick(vp, 46));
        view.findViewById(R.id.s23).setOnClickListener(new OnContentClick(vp, 48));
    }
